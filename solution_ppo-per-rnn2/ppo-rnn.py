...
class Actor(nn.Module):
    def __init__(self, input_num, hidden_num, output_num, layers=2):
        ...
        self.action_head = nn.Linear(output_num, output_num)
        # self.action_head = nn.Linear(hidden_num, output_num)
...
class Critic(nn.Module):
    def __init__(self, input_num, hidden_num, output_num=1, layers=2):
        ...
        self.fc1 = nn.Linear(hidden_num, output_num)
        self.state_value = nn.Linear(output_num, output_num)
        # self.state_value = nn.Linear(hidden_num, output_num)
